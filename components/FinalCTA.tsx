  ...
  return (
    <section id="final-cta" ref={ref} className="w-full py-32 px-8 bg-gradient-to-br from-gray-50 via-white to-blue-50/30 relative overflow-hidden">
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#00FFFF] rounded-full blur-3xl animate-pulse" />
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <button
            style={{ fontFamily: 'Roboto, sans-serif', fontWeight: 900 }}
            className="px-10 py-4 bg-[#001156] hover:bg-[#030834] text-white border border-[#00FFFF]/50 rounded-[10px] transition-all duration-300 hover:scale-105 shadow-xl shadow-[#001156]/30"
          >
