  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 50% 100% at 50% 50%, rgba(0,17,86,0.15), transparent 65%)',
          filter: 'blur(60px)',
        }}
      />
      ...
      <div
        ...
        style={{
          backgroundImage:
            'linear-gradient(to right, rgba(0,17,86,0.2) 1px, transparent 1px), linear-gradient(to bottom, rgba(0,17,86,0.2) 1px, transparent 1px)',
