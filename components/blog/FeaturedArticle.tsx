    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <Link href={`/blog/${articulo.slug}`} className="block group no-underline">
          <article className="card-glow relative grid lg:grid-cols-2 gap-0 overflow-hidden rounded-3xl bg-gradient-to-br from-slate-50 via-blue-50/40 to-white border border-[#001156]/20 hover:border-[#00FFFF] shadow-sm hover:shadow-md transition-colors duration-500">
            {/* Image side */}
            <div className="relative h-72 lg:h-[28rem] overflow-hidden bg-slate-100">
              {showImage ? (
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-[#001156]/10 via-blue-50/40 to-white flex items-center justify-center">
                  <div className="w-48 h-48 rounded-full bg-[#001156]/20 blur-3xl" />
                </div>
              )}
              ...
              {articulo.categoria && (
                <div className="absolute top-6 left-6">
                  <span
                    className="inline-flex items-center px-4 py-2 rounded-full bg-white/80 backdrop-blur-md border border-[#001156]/30 text-[#001156] text-xs tracking-wider uppercase"
            ...
            <div className="relative p-8 lg:p-12 flex flex-col justify-between">
              ...
              <div className="flex items-center justify-between">
                <span
                  className="inline-flex items-center gap-3 text-[#001156]"
                  style={{ fontFamily: 'Roboto, sans-serif', fontWeight: 300 }}
                >
                  Leer artículo
