    ...
    <header className="relative pt-32 md:pt-40 pb-12 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        >
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 text-white/50 hover:text-[#00ffff] transition-colors duration-300 text-sm mb-10 no-underline group"
        ...
        >
          {categoria && (
            <span
              className="inline-flex items-center px-4 py-1.5 rounded-full bg-[#00ffff]/10 border border-[#00ffff]/30 text-[#00ffff] text-xs tracking-[0.18em] uppercase"
              style={{ fontFamily: 'Lexend, sans-serif', fontWeight: 300 }}
            >
              {categoria}
            </span>
        ...
        <motion.h1
          ...
          className="text-4xl md:text-5xl lg:text-6xl text-white leading-[1.05] tracking-tight mb-10"
