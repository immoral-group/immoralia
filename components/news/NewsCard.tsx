  ...
  if (variant === 'minimal') {
    return (
      <Link
        ...
        className="group no-underline block py-5 border-t border-white/10 first:border-t-0"
      >
    ...
    return (
      ...
      >
        <article className="grid grid-cols-[40%_1fr] gap-5 p-5 hover:bg-white/[0.02] transition-colors h-full">
          <div className="aspect-[4/3] overflow-hidden bg-gradient-to-br from-[#3B80DF]/15 to-black">
            {showImage ? (
              <img
              ...
              <div className="w-full h-full bg-gradient-to-br from-[#3B80DF]/25 to-black" />
            )}
          </div>
          <div className="flex flex-col">
            ...
            <Timestamp
              date={articulo.fecha_publicacion}
              className="text-white/35 mt-auto pt-3"
            />
          </div>
        </article>
      </Link>
  ...
  return (
    ...
    >
      <article className="flex flex-col h-full">
        <div className="aspect-[16/10] overflow-hidden bg-gradient-to-br from-[#3B80DF]/15 to-black mb-4">
          {showImage ? (
            <img
              src={articulo.imagen_url || ''}
              alt={articulo.titular}
