...
export default function Page() {
  return (
    <div className="w-full bg-black relative">
      ...
      {/* Gradient orbs */}
      <div className="fixed top-0 -left-20 w-96 h-96 bg-[#3B80DF] rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse pointer-events-none" />
      <div className="fixed top-1/3 -right-20 w-96 h-96 bg-[#3B80DF] rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse pointer-events-none" style={{ animationDelay: '2s' }} />
      <div className="fixed bottom-0 left-1/2 w-96 h-96 bg-[#3B80DF] rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse pointer-events-none" style={{ animationDelay: '4s' }} />
