      ...
      <div>
        ...
        >
          ...
          <p className="text-sm mb-1">
            Voto:{' '}
            <span className="font-semibold capitalize">{votoRegistrado}</span>
          </p>
          <p className="text-sm mb-1">
            Puntuación:{' '}
            <span className="font-semibold">{puntuacion} / 5</span>
          </p>
          {nota && (
      ...
      >
          ...
          {[1, 2, 3, 4, 5].map((n) => (
            <button
              ...
              style={{
                ...
                backgroundColor:
                  puntuacion === n ? 'white' : 'transparent',
                color:
                  puntuacion === n ? 'black' : 'rgba(255,255,255,0.4)',
                border:
                  puntuacion === n
                    ? 'none'
        ...
        <button
          ...
          style={{
            ...
            backgroundColor:
              puntuacion !== null ? 'white' : 'rgba(255,255,255,0.2)',
            color:
              puntuacion !== null ? 'black' : 'rgba(255,255,255,0.3)',
            border: 'none',
            transition: 'all 0.15s',
            fontFamily: 'Lexend, sans-serif',
          }}
